...
// Normalize helper to strip trailing slashes
...
export const API_ENDPOINTS = {
  ...
  SOLUTION_CATEGORIES: {
    BASE: SOLUTION_CATEGORIES_URL,
    GET_ALL: SOLUTION_CATEGORIES_URL,
    GET_BY_ID: (id) => `${SOLUTION_CATEGORIES_URL}/${id}`,
    CREATE: SOLUTION_CATEGORIES_URL,
    UPDATE: (id) => `${SOLUTION_CATEGORIES_URL}/${id}`,
    DELETE: (id) => `${SOLUTION_CATEGORIES_URL}/${id}`,
  },
  SERVICES: {
    BASE: SERVICES_URL,
  ...
  SOLUTIONS: {
    BASE: SOLUTIONS_URL,
    GET_ALL: SOLUTIONS_URL,
    GET_BY_ID: (id) => `${SOLUTIONS_URL}/${id}`,
    CREATE: SOLUTIONS_URL,
    UPDATE: (id) => `${SOLUTIONS_URL}/${id}`,
    DELETE: (id) => `${SOLUTIONS_URL}/${id}`,
    GET_BY_CATEGORY: (categoryId) => `${SOLUTIONS_URL}/category/${categoryId}`,
    GET_CATEGORIES: `${SOLUTIONS_URL}/categories`,
  },
  S3: {
    UPLOAD: `${S3_URL}/upload`,
    DELETE: `${S3_URL}/delete`,
  },
  PARTNERS: {
    BASE: PARTNERS_URL,
    GET_ALL: PARTNERS_URL,
    GET_BY_ID: (id) => `${PARTNERS_URL}/${id}`,
    CREATE: PARTNERS_URL,
    UPDATE: (id) => `${PARTNERS_URL}/${id}`,
    DELETE: (id) => `${PARTNERS_URL}/${id}`,
  },
  CAREERS: {
    BASE: CAREERS_URL,
