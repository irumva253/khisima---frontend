        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredAndSortedServices.length === 0 ? (
            <div className="bg-white rounded-2xl shadow-xl p-12 text-center border border-gray-100 animate-fade-in">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">No published services found</h3>
              ...
              {filteredAndSortedServices.map((service, index) => (
                ...
                >
                  ...
                  <div className={`relative ${viewMode === 'list' ? 'w-64 flex-shrink-0' : 'h-48'} overflow-hidden`}>
                    ...
                    <div className={`${service.fileKey ? 'hidden' : 'flex'} w-full h-full bg-gradient-to-br from-blue-200 to-indigo-200 items-center justify-center`}>
